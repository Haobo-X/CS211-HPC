        ...
        for (i = 0; i < n; i += b)
        {
            ...
            for (j = 0; j < n; j += b)
            {
                ...
                for (i1 = i; i1 < i + b; i1 += 3)
                {
                    ...
                    {
                        register double C_0_0 = i1 < (i + b) && j1 < (j + b) && i1 < n && j1 < n ? C[i1 * n + j1];
                        register double C_1_0 = i1 < (i + b - 1) && j1 < (j + b) && i1 < (n - 1) && j1 < n ? C[(i1 + 1) * n + j1];
                        register double C_2_0 = i1 < (i + b - 2) && j1 < (j + b) && i1 < (n - 2) && j1 < n ? C[(i1 + 2) * n + j1];

                        register double C_0_1 = i1 < (i + b) && j1 < (j + b - 1) && i1 < n && j1 < (n - 1) ? C[i1 * n + (j1 + 1)];
                        register double C_1_1 = i1 < (i + b - 1) && j1 < (j + b - 1) && i1 < (n - 1) && j1 < (n - 1) ? C[(i1 + 1) * n + (j1 + 1)];
                        register double C_2_1 = i1 < (i + b - 2) && j1 < (j + b - 1) && i1 < (n - 2) && j1 < (n - 1) ? C[(i1 + 2) * n + (j1 + 1)];

                        register double C_0_2 = i1 < (i + b) && j1 < (j + b - 2) && i1 < n && j1 < (n - 2) ? C[i1 * n + (j1 + 2)];
                        register double C_1_2 = i1 < (i + b - 1) && j1 < (j + b - 2) && i1 < (n - 1) && j1 < (n - 2) ? C[(i1 + 1) * n + (j1 + 2)];
                        register double C_2_2 = i1 < (i + b - 2) && j1 < (j + b - 2) && i1 < (n - 2) && j1 < (n - 2) ? C[(i1 + 2) * n + (j1 + 2)];

                        register double C_0_3 = i1 < (i + b) && j1 < (j + b - 3) && i1 < n && j1 < (n - 3) ? C[i1 * n + (j1 + 3)];
                        register double C_1_3 = i1 < (i + b - 1) && j1 < (j + b - 3) && i1 < (n - 1) && j1 < (n - 3) ? C[(i1 + 1) * n + (j1 + 3)];
                        register double C_2_3 = i1 < (i + b - 2) && j1 < (j + b - 3) && i1 < (n - 2) && j1 < (n - 3) ? C[(i1 + 2) * n + (j1 + 3)];

                        int k1 = 0;
                        for (k1 = k; k1 < k + b; k1++)
                        {
                            register double A_0_M = i1 < (i + b) && k1 < (k + b) && i1 < n && k1 < n ? A[i1 * n + k1];
                            register double A_1_M = i1 < (i + b - 1) && k1 < (k + b) && i1 < (n - 1) && k1 < n ? A[(i1 + 1) * n + k1];
                            register double A_2_M = i1 < (i + b - 2) && k1 < (k + b) && i1 < (n - 2) && k1 < n ? A[(i1 + 2) * n + k1];

                            register double B_M = k1 < (k + b) && j1 < (j + b) && k1 < n && j1 < n ? B[k1 * n + j1];
                            C_0_0 += A_0_M * B_M;
                            C_1_0 += A_1_M * B_M;
                            C_2_0 += A_2_M * B_M;

                            B_M = k1 < (k + b) && j1 < (j + b - 1) && k1 < n && j1 < (n - 1) ? B[k1 * n + (j1 + 1)];
                            C_0_1 += A_0_M * B_M;
                            C_1_1 += A_1_M * B_M;
                            C_2_1 += A_2_M * B_M;

                            B_M = k1 < (k + b) && j1 < (j + b - 2) && k1 < n && j1 < (n - 2) ? B[k1 * n + (j1 + 2)];
                            C_0_2 += A_0_M * B_M;
                            C_1_2 += A_1_M * B_M;
                            C_2_2 += A_2_M * B_M;

                            B_M = k1 < (k + b) && j1 < (j + b - 3) && k1 < n && j1 < (n - 3) ? B[k1 * n + (j1 + 3)];
                            C_0_3 += A_0_M * B_M;
                            C_1_3 += A_1_M * B_M;
                            C_2_3 += A_2_M * B_M;
                        }
